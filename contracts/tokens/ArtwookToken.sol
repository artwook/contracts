...
contract ArtwookToken is StandardToken, Ownable {
    ...
    uint256 public constant tokenTotalSupply = 200 * (10**6) * (10**decimals); // 100 million BOT ever created

    // Events
    event Mint(uint256 supply, address indexed to, uint256 amount);

    /// @notice Creates new ArtwookToken contract
    function ArtwookToken() public {
    }
